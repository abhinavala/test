...
-- Unique constraint for one score per session-participant pair
...
-- Index for calculatedAt queries
CREATE INDEX "participant_engagement_scores_calculatedAt_idx" ON "participant_engagement_scores"("calculatedAt");
